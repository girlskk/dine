...
func (opq *OrderProductQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (opq *OrderProductQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (opq *OrderProductQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (opq *OrderProductQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (opq *OrderProductQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (opq *OrderProductQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := opq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (opq *OrderProductQuery) loadOrder(ctx context.Context, query *OrderQuery, nodes []*OrderProduct, init func(*OrderProduct), assign func(*OrderProduct, *Order)) error {
	...
	nodeids := make(map[uuid.UUID][]*OrderProduct)
	for i := range nodes {
		fk := nodes[i].OrderID
...
func (opq *OrderProductQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(orderproduct.Table, orderproduct.Columns, sqlgraph.NewFieldSpec(orderproduct.FieldID, field.TypeUUID))
	_spec.From = opq.sql
...
func (opq *OrderProductQuery) Modify(modifiers ...func(s *sql.Selector)) *OrderProductSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (ops *OrderProductSelect) Modify(modifiers ...func(s *sql.Selector)) *OrderProductSelect {
