...
const (
	...
	ItemsTable = "product_attr_items"
	// ItemsInverseTable is the table name for the ProductAttrItem entity.
	// It exists in this package in order to avoid circular dependency with the "productattritem" package.
	ItemsInverseTable = "product_attr_items"
...
// OrderOption defines the ordering options for the ProductAttr queries.
