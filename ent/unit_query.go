...
func (uq *UnitQuery) QueryProducts() *ProductQuery {
...
func (uq *UnitQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (uq *UnitQuery) WithProducts(opts ...func(*ProductQuery)) *UnitQuery {
	query := (&ProductClient{config: uq.config}).Query()
...
func (uq *UnitQuery) loadProducts(ctx context.Context, query *ProductQuery, nodes []*Unit, init func(*Unit), assign func(*Unit, *Product)) error {
...
func (uq *UnitQuery) ForUpdate(opts ...sql.LockOption) *UnitQuery {
...
func (uq *UnitQuery) ForShare(opts ...sql.LockOption) *UnitQuery {
	if uq.driver.Dialect() == dialect.Postgres {
		uq.Unique(false)
	}
	uq.modifiers = append(uq.modifiers, func(s *sql.Selector) {
