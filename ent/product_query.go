...
type ProductQuery struct {
	...
	withProductSpecs       *ProductSpecQuery
	withSetMealDetails     *SetMealDetailQuery
	withIncludedInSetMeals *SetMealDetailQuery
...
func (pq *ProductQuery) QueryAttrs() *AttrQuery {
	query := (&AttrClient{config: pq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := pq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (pq *ProductQuery) QueryRecipes() *RecipeQuery {
...
func (pq *ProductQuery) QueryProductSpecs() *ProductSpecQuery {
	query := (&ProductSpecClient{config: pq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := pq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryIncludedInSetMeals chains the current query on the "included_in_set_meals" edge.
func (pq *ProductQuery) QueryIncludedInSetMeals() *SetMealDetailQuery {
	query := (&SetMealDetailClient{config: pq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := pq.prepareQuery(ctx); err != nil {
			return nil, err
...
func (pq *ProductQuery) QueryOrderCartItems() *OrderCartQuery {
	query := (&OrderCartClient{config: pq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := pq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (pq *ProductQuery) Clone() *ProductQuery {
	...
	return &ProductQuery{
		...
		withAttrs:              pq.withAttrs.Clone(),
		withRecipes:            pq.withRecipes.Clone(),
		withProductSpecs:       pq.withProductSpecs.Clone(),
		withSetMealDetails:     pq.withSetMealDetails.Clone(),
		withIncludedInSetMeals: pq.withIncludedInSetMeals.Clone(),
		withOrderCartItems:     pq.withOrderCartItems.Clone(),
...
func (pq *ProductQuery) WithAttrs(opts ...func(*AttrQuery)) *ProductQuery {
	query := (&AttrClient{config: pq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (pq *ProductQuery) WithRecipes(opts ...func(*RecipeQuery)) *ProductQuery {
	query := (&RecipeClient{config: pq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	pq.withRecipes = query
	return pq
}
...
func (pq *ProductQuery) WithProductSpecs(opts ...func(*ProductSpecQuery)) *ProductQuery {
	query := (&ProductSpecClient{config: pq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	pq.withProductSpecs = query
	return pq
}
...
// WithIncludedInSetMeals tells the query-builder to eager-load the nodes that are connected to
// the "included_in_set_meals" edge. The optional arguments are used to configure the query builder of the edge.
func (pq *ProductQuery) WithIncludedInSetMeals(opts ...func(*SetMealDetailQuery)) *ProductQuery {
	query := (&SetMealDetailClient{config: pq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	pq.withIncludedInSetMeals = query
	return pq
}
...
func (pq *ProductQuery) WithOrderCartItems(opts ...func(*OrderCartQuery)) *ProductQuery {
	query := (&OrderCartClient{config: pq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	pq.withOrderCartItems = query
	return pq
}
...
func (pq *ProductQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Product, error) {
	var (
		...
		loadedTypes = [8]bool{
			...
			pq.withIncludedInSetMeals != nil,
			pq.withOrderCartItems != nil,
		}
	)
	...
	if query := pq.withAttrs; query != nil {
		if err := pq.loadAttrs(ctx, query, nodes,
			func(n *Product) { n.Edges.Attrs = []*Attr{} },
			func(n *Product, e *Attr) { n.Edges.Attrs = append(n.Edges.Attrs, e) }); err != nil {
			return nil, err
		}
	}
	if query := pq.withRecipes; query != nil {
		if err := pq.loadRecipes(ctx, query, nodes,
			func(n *Product) { n.Edges.Recipes = []*Recipe{} },
			func(n *Product, e *Recipe) { n.Edges.Recipes = append(n.Edges.Recipes, e) }); err != nil {
			return nil, err
		}
	}
	if query := pq.withProductSpecs; query != nil {
		if err := pq.loadProductSpecs(ctx, query, nodes,
			func(n *Product) { n.Edges.ProductSpecs = []*ProductSpec{} },
			func(n *Product, e *ProductSpec) { n.Edges.ProductSpecs = append(n.Edges.ProductSpecs, e) }); err != nil {
			return nil, err
		}
	}
	...
	if query := pq.withIncludedInSetMeals; query != nil {
		if err := pq.loadIncludedInSetMeals(ctx, query, nodes,
			func(n *Product) { n.Edges.IncludedInSetMeals = []*SetMealDetail{} },
			func(n *Product, e *SetMealDetail) { n.Edges.IncludedInSetMeals = append(n.Edges.IncludedInSetMeals, e) }); err != nil {
			return nil, err
		}
	}
	if query := pq.withOrderCartItems; query != nil {
		if err := pq.loadOrderCartItems(ctx, query, nodes,
			func(n *Product) { n.Edges.OrderCartItems = []*OrderCart{} },
			func(n *Product, e *OrderCart) { n.Edges.OrderCartItems = append(n.Edges.OrderCartItems, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (pq *ProductQuery) loadAttrs(ctx context.Context, query *AttrQuery, nodes []*Product, init func(*Product), assign func(*Product, *Attr)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(product.AttrsTable)
		s.Join(joinT).On(s.C(attr.FieldID), joinT.C(product.AttrsPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(product.AttrsPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(product.AttrsPrimaryKey[0]))
	...
	neighbors, err := withInterceptors[[]*Attr](ctx, query, qr, query.inters)
	if err != nil {
		return err
	}
	for _, n := range neighbors {
		nodes, ok := nids[n.ID]
		if !ok {
			return fmt.Errorf(`unexpected "attrs" node returned %v`, n.ID)
		}
		for kn := range nodes {
			assign(kn, n)
		}
...
func (pq *ProductQuery) loadRecipes(ctx context.Context, query *RecipeQuery, nodes []*Product, init func(*Product), assign func(*Product, *Recipe)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[int]*Product)
	nids := make(map[int]map[*Product]struct{})
	for i, node := range nodes {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(product.RecipesTable)
		s.Join(joinT).On(s.C(recipe.FieldID), joinT.C(product.RecipesPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(product.RecipesPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(product.RecipesPrimaryKey[0]))
		s.AppendSelect(columns...)
		s.SetDistinct(false)
	})
	if err := query.prepareQuery(ctx); err != nil {
...
func (pq *ProductQuery) loadProductSpecs(ctx context.Context, query *ProductSpecQuery, nodes []*Product, init func(*Product), assign func(*Product, *ProductSpec)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(productspec.FieldProductID)
	}
	query.Where(predicate.ProductSpec(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(product.ProductSpecsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (pq *ProductQuery) loadSetMealDetails(ctx context.Context, query *SetMealDetailQuery, nodes []*Product, init func(*Product), assign func(*Product, *SetMealDetail)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(setmealdetail.FieldSetMealID)
	}
	...
	for _, n := range neighbors {
		...
		node, ok := nodeids[fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "set_meal_id" returned %v for node %v`, fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (pq *ProductQuery) loadIncludedInSetMeals(ctx context.Context, query *SetMealDetailQuery, nodes []*Product, init func(*Product), assign func(*Product, *SetMealDetail)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Product)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.SetMealDetail(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(product.IncludedInSetMealsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (pq *ProductQuery) loadOrderCartItems(ctx context.Context, query *OrderCartQuery, nodes []*Product, init func(*Product), assign func(*Product, *OrderCart)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Product)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(ordercart.FieldProductID)
	}
	query.Where(predicate.OrderCart(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(product.OrderCartItemsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
