...
func (rmq *RoleMenuQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (rmq *RoleMenuQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (rmq *RoleMenuQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (rmq *RoleMenuQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (rmq *RoleMenuQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (rmq *RoleMenuQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := rmq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (rmq *RoleMenuQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(rolemenu.Table, rolemenu.Columns, sqlgraph.NewFieldSpec(rolemenu.FieldID, field.TypeUUID))
	_spec.From = rmq.sql
