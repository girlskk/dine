...
const (
	// Label holds the string label denoting the frontenduser type in the database.
	Label = "frontend_user"
	...
	EdgeStore = "store"
	// Table holds the table name of the frontenduser in the database.
	Table = "frontend_users"
	// StoreTable is the table that holds the store relation/edge.
	StoreTable = "frontend_users"
...
// Columns holds all SQL columns for frontenduser fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the FrontendUser queries.
