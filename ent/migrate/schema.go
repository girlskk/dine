...
var (
	...
	OrdersColumns = []*schema.Column{
		...
		{Name: "order_status", Type: field.TypeEnum, Enums: []string{"DRAFT", "PLACED", "IN_PROGRESS", "READY", "COMPLETED", "CANCELLED", "VOIDED", "MERGED"}, Default: "PLACED"},
		...
		{Name: "channel", Type: field.TypeEnum, Enums: []string{"POS", "MINI_PROGRAM"}, Default: "POS"},
