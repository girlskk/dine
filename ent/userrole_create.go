...
func (urc *UserRoleCreate) SetUserType(dt domain.UserType) *UserRoleCreate {
	urc.mutation.SetUserType(dt)
	return urc
}
...
func (urc *UserRoleCreate) SetMerchantID(u uuid.UUID) *UserRoleCreate {
	urc.mutation.SetMerchantID(u)
	return urc
}

// SetNillableMerchantID sets the "merchant_id" field if the given value is not nil.
func (urc *UserRoleCreate) SetNillableMerchantID(u *uuid.UUID) *UserRoleCreate {
	if u != nil {
		urc.SetMerchantID(*u)
	}
	return urc
...
func (urc *UserRoleCreate) SetStoreID(u uuid.UUID) *UserRoleCreate {
	urc.mutation.SetStoreID(u)
	return urc
}

// SetNillableStoreID sets the "store_id" field if the given value is not nil.
func (urc *UserRoleCreate) SetNillableStoreID(u *uuid.UUID) *UserRoleCreate {
	if u != nil {
		urc.SetStoreID(*u)
	}
	return urc
...
func (urc *UserRoleCreate) check() error {
	...
	if _, ok := urc.mutation.UserType(); !ok {
		return &ValidationError{Name: "user_type", err: errors.New(`ent: missing required field "UserRole.user_type"`)}
	}
	if v, ok := urc.mutation.UserType(); ok {
...
func (urc *UserRoleCreate) createSpec() (*UserRole, *sqlgraph.CreateSpec) {
	...
	if value, ok := urc.mutation.UserType(); ok {
...
// SetDeletedAt sets the "deleted_at" field.
func (u *UserRoleUpsert) SetDeletedAt(v int64) *UserRoleUpsert {
...
func (u *UserRoleUpsert) AddDeletedAt(v int64) *UserRoleUpsert {
	u.Add(userrole.FieldDeletedAt, v)
	return u
}

// SetUserType sets the "user_type" field.
func (u *UserRoleUpsert) SetUserType(v domain.UserType) *UserRoleUpsert {
	u.Set(userrole.FieldUserType, v)
	return u
}

// UpdateUserType sets the "user_type" field to the value that was provided on create.
func (u *UserRoleUpsert) UpdateUserType() *UserRoleUpsert {
	u.SetExcluded(userrole.FieldUserType)
	return u
}
...
func (u *UserRoleUpsertOne) UpdateNewValues() *UserRoleUpsertOne {
	...
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(s *sql.UpdateSet) {
		...
		if _, exists := u.create.mutation.StoreID(); exists {
			s.SetIgnore(userrole.FieldStoreID)
		}
	}))
	return u
}
...
// SetDeletedAt sets the "deleted_at" field.
func (u *UserRoleUpsertOne) SetDeletedAt(v int64) *UserRoleUpsertOne {
	return u.Update(func(s *UserRoleUpsert) {
		s.SetDeletedAt(v)
	})
}
...
// AddDeletedAt adds v to the "deleted_at" field.
func (u *UserRoleUpsertOne) AddDeletedAt(v int64) *UserRoleUpsertOne {
	return u.Update(func(s *UserRoleUpsert) {
		s.AddDeletedAt(v)
	})
}
...
// SetUserType sets the "user_type" field.
func (u *UserRoleUpsertOne) SetUserType(v domain.UserType) *UserRoleUpsertOne {
	return u.Update(func(s *UserRoleUpsert) {
		s.SetUserType(v)
	})
}
...
// SetDeletedAt sets the "deleted_at" field.
func (u *UserRoleUpsertBulk) SetDeletedAt(v int64) *UserRoleUpsertBulk {
	return u.Update(func(s *UserRoleUpsert) {
		s.SetDeletedAt(v)
	})
}
...
// AddDeletedAt adds v to the "deleted_at" field.
func (u *UserRoleUpsertBulk) AddDeletedAt(v int64) *UserRoleUpsertBulk {
	return u.Update(func(s *UserRoleUpsert) {
		s.AddDeletedAt(v)
	})
}
...
// SetUserType sets the "user_type" field.
func (u *UserRoleUpsertBulk) SetUserType(v domain.UserType) *UserRoleUpsertBulk {
	return u.Update(func(s *UserRoleUpsert) {
		s.SetUserType(v)
	})
}
