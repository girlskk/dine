...
func (dq *DistrictQuery) QueryCountry() *CountryQuery {
	query := (&CountryClient{config: dq.config}).Query()
...
func (dq *DistrictQuery) QueryMerchants() *MerchantQuery {
	query := (&MerchantClient{config: dq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := dq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (dq *DistrictQuery) QueryStores() *StoreQuery {
	query := (&StoreClient{config: dq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := dq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (dq *DistrictQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (dq *DistrictQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (dq *DistrictQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (dq *DistrictQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (dq *DistrictQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (dq *DistrictQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := dq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (dq *DistrictQuery) Clone() *DistrictQuery {
	...
	return &DistrictQuery{
		...
		withCountry:   dq.withCountry.Clone(),
		withProvince:  dq.withProvince.Clone(),
		withCity:      dq.withCity.Clone(),
		withMerchants: dq.withMerchants.Clone(),
		withStores:    dq.withStores.Clone(),
...
func (dq *DistrictQuery) WithCountry(opts ...func(*CountryQuery)) *DistrictQuery {
	query := (&CountryClient{config: dq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	dq.withCountry = query
	return dq
}
...
func (dq *DistrictQuery) WithMerchants(opts ...func(*MerchantQuery)) *DistrictQuery {
	query := (&MerchantClient{config: dq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	dq.withMerchants = query
	return dq
}
...
func (dq *DistrictQuery) WithStores(opts ...func(*StoreQuery)) *DistrictQuery {
	query := (&StoreClient{config: dq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (dq *DistrictQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*District, error) {
	...
	if query := dq.withCountry; query != nil {
		if err := dq.loadCountry(ctx, query, nodes, nil,
			func(n *District, e *Country) { n.Edges.Country = e }); err != nil {
			return nil, err
		}
	}
	...
	if query := dq.withMerchants; query != nil {
		if err := dq.loadMerchants(ctx, query, nodes,
			func(n *District) { n.Edges.Merchants = []*Merchant{} },
			func(n *District, e *Merchant) { n.Edges.Merchants = append(n.Edges.Merchants, e) }); err != nil {
			return nil, err
		}
	}
	if query := dq.withStores; query != nil {
		if err := dq.loadStores(ctx, query, nodes,
			func(n *District) { n.Edges.Stores = []*Store{} },
			func(n *District, e *Store) { n.Edges.Stores = append(n.Edges.Stores, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (dq *DistrictQuery) loadCountry(ctx context.Context, query *CountryQuery, nodes []*District, init func(*District), assign func(*District, *Country)) error {
...
func (dq *DistrictQuery) loadMerchants(ctx context.Context, query *MerchantQuery, nodes []*District, init func(*District), assign func(*District, *Merchant)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(merchant.FieldDistrictID)
	}
	query.Where(predicate.Merchant(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(district.MerchantsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (dq *DistrictQuery) loadStores(ctx context.Context, query *StoreQuery, nodes []*District, init func(*District), assign func(*District, *Store)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*District)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(store.FieldDistrictID)
	}
	query.Where(predicate.Store(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(district.StoresColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (dq *DistrictQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := dq.ctx.Fields; len(fields) > 0 {
		...
		if dq.withCountry != nil {
			_spec.Node.AddColumnOnce(district.FieldCountryID)
		}
...
func (dq *DistrictQuery) ForUpdate(opts ...sql.LockOption) *DistrictQuery {
...
func (dq *DistrictQuery) ForShare(opts ...sql.LockOption) *DistrictQuery {
	if dq.driver.Dialect() == dialect.Postgres {
		dq.Unique(false)
	}
	dq.modifiers = append(dq.modifiers, func(s *sql.Selector) {
