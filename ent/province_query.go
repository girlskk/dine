...
func (pq *ProvinceQuery) QueryMerchants() *MerchantQuery {
...
func (pq *ProvinceQuery) QueryStores() *StoreQuery {
...
func (pq *ProvinceQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (pq *ProvinceQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (pq *ProvinceQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (pq *ProvinceQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (pq *ProvinceQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (pq *ProvinceQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := pq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (pq *ProvinceQuery) Clone() *ProvinceQuery {
	...
	return &ProvinceQuery{
		...
		withMerchants: pq.withMerchants.Clone(),
...
func (pq *ProvinceQuery) WithMerchants(opts ...func(*MerchantQuery)) *ProvinceQuery {
	query := (&MerchantClient{config: pq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	pq.withMerchants = query
	return pq
}
...
func (pq *ProvinceQuery) WithStores(opts ...func(*StoreQuery)) *ProvinceQuery {
	query := (&StoreClient{config: pq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (pq *ProvinceQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Province, error) {
	...
	if query := pq.withMerchants; query != nil {
		if err := pq.loadMerchants(ctx, query, nodes,
			func(n *Province) { n.Edges.Merchants = []*Merchant{} },
			func(n *Province, e *Merchant) { n.Edges.Merchants = append(n.Edges.Merchants, e) }); err != nil {
			return nil, err
		}
	}
	if query := pq.withStores; query != nil {
		if err := pq.loadStores(ctx, query, nodes,
			func(n *Province) { n.Edges.Stores = []*Store{} },
			func(n *Province, e *Store) { n.Edges.Stores = append(n.Edges.Stores, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (pq *ProvinceQuery) loadMerchants(ctx context.Context, query *MerchantQuery, nodes []*Province, init func(*Province), assign func(*Province, *Merchant)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Province)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(merchant.FieldProvinceID)
	}
	query.Where(predicate.Merchant(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(province.MerchantsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (pq *ProvinceQuery) loadStores(ctx context.Context, query *StoreQuery, nodes []*Province, init func(*Province), assign func(*Province, *Store)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Province)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(store.FieldProvinceID)
	}
	query.Where(predicate.Store(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(province.StoresColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (pq *ProvinceQuery) ForUpdate(opts ...sql.LockOption) *ProvinceQuery {
...
func (pq *ProvinceQuery) ForShare(opts ...sql.LockOption) *ProvinceQuery {
	if pq.driver.Dialect() == dialect.Postgres {
		pq.Unique(false)
	}
	pq.modifiers = append(pq.modifiers, func(s *sql.Selector) {
