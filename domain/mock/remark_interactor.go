...
func (m *MockRemarkInteractor) Create(arg0 context.Context, arg1 *domain.Remark) error {
	m.ctrl.T.Helper()
...
func (m *MockRemarkInteractor) Update(arg0 context.Context, arg1 *domain.Remark) error {
	m.ctrl.T.Helper()
