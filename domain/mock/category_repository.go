...
func (m *MockCategoryRepository) Delete(arg0 context.Context, arg1 int) error {
	m.ctrl.T.Helper()
...
func (m *MockCategoryRepository) FindByID(arg0 context.Context, arg1 int) (*domain.Category, error) {
	m.ctrl.T.Helper()
