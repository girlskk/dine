...
type DepartmentHandlerParams struct {
	fx.In
	Interactor domain.DepartmentInteractor
	DeptSeq    domain.IncrSequence `name:"store_department_seq"`
}
...
func (h *DepartmentHandler) Create() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err := h.Interactor.CreateDepartment(ctx, params); err != nil {
...
func (h *DepartmentHandler) Update() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		params := &domain.UpdateDepartmentParams{ID: id, Name: req.Name, Enable: req.Enable}
