...
type Promotion struct {
	...
	Meta           json.RawMessage `json:"meta,omitempty"`  // 促销扩展信息
}
...
type Fee struct {
	...
	Meta   json.RawMessage `json:"meta,omitempty"` // 扩展信息
}
...
type Coupon struct {
	...
	Meta           json.RawMessage `json:"meta,omitempty"`  // 卡券扩展信息
}
...
type Product struct {
	...
	Options json.RawMessage `json:"options,omitempty"` // 做法/加料（结构化）
}
...
type Order struct {
	...
	MerchantID string `json:"merchant_id"` // 品牌商ID
	...
	FulfillmentStatus string `json:"fulfillment_status,omitempty"` // 外卖/配送状态
...
type CreateOrderReq struct {
	MerchantID string `json:"merchant_id" binding:"required"` // 品牌商ID
	...
	OriginOrderID string  `json:"origin_order_id,omitempty"`                               // 原正单订单ID（退款/部分退款单使用）
...
type UpdateOrderReq struct {
	...
	OrderType     *string `json:"order_type,omitempty" enums:"SALE,REFUND,PARTIAL_REFUND"`
	OriginOrderID *string `json:"origin_order_id,omitempty"`
	Refund        *Refund `json:"refund,omitempty"`

	DiningMode *string  `json:"dining_mode,omitempty" enums:"DINE_IN,TAKEAWAY"`
	Store      *Store   `json:"store,omitempty"`
	Channel    *Channel `json:"channel,omitempty"`
	POS        *POS     `json:"pos,omitempty"`
	Cashier    *Cashier `json:"cashier,omitempty"`
