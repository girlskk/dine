...
type MenuCreateReq struct {
	...
	DistributionRule domain.MenuDistributionRule `json:"distribution_rule" binding:"required,oneof=override keep"` // 下发规则（必选）
...
type MenuItemReq struct {
	...
	SaleRule    domain.MenuItemSaleRule `json:"sale_rule" binding:"required,oneof=keep_brand_status keep_store_status"` // 下发售卖规则（必选）
