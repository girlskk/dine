...
type RemarkCreateReq struct {
	...
	RemarkType domain.RemarkType `json:"remark_type" binding:"required,oneof=system brand"` // 备注归属方
...
type RemarkListReq struct {
	...
	RemarkType domain.RemarkType `form:"remark_type" json:"remark_type" binding:"omitempty,oneof=system brand"` // 备注创建方
}
